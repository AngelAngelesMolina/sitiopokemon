...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  if(!pokemon ){
    ...
    return {
      redirect: {
        destination:'/', //lo enviamos al home 
        permanent: false //ayuda  a los bots si es verdadera significa que ya nunca se redirigira a otra pagina, false porque puede ser que ya exista ese pokemon
      }
    }
  }
  ...
  return {
    ...
    revalidate: 86400, //segundos, minutos y horas 60 * 60 * 24 VALIDAR CADA 24 HRS 
  }
}
